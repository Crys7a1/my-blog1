            ...
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-tab-pane label="技术博客" name="first">
                    <div class="block">
                        ...
                        <el-button type="primary" id="add" @click="add"
                            >录入</el-button
                        >
                        <aside>
                            <ul class="related">
                    ...
                    ><el-collapse accordion>
                        <el-collapse-item>
                            ...
                            <div>
                                <h3>独立版本</h3>
                                <p>
                                    我们可以在 Vue.js 的官网上直接下载
                                    vue.min.js 并用 script 标签引入。
                                </p>
                                <h3>使用 CDN 方法</h3>
                                <p>
                                    以下推荐国外比较稳定的两个
                        ...
                        <el-collapse-item title="--配置 MongoDB--">
                            <h3>创建数据目录</h3>
                            <p>
                                已经在 C 盘安装了 mongodb，现在让我们创建一个
                                data 的目录然后在 data 目录里创建 db 目录。<br />
                                cd C:\<br />
                                md "\data\db"<br />
                            </p>
                            ...
                            <h3>连接MongoDB</h3>
                            <p>
                                我们可以在命令窗口中运行 mongo.exe
                                命令即可连接上 MongoDB，执行如下命令：<br />
                            ...
                            <p>
                                ...
                                > db.runoob.find()<br />
                                { "_id" : ObjectId("5604ff74a274a611b0c990aa"),
                                "x" : 10 }<br />
                                >
                            </p>
                        </el-collapse-item>
                        <el-collapse-item title="--Vue中使用 Highcharts--">
                            ...
                            <p>
                                ...
                                import Vue from 'vue' import HighchartsVue from
                                'highcharts-vue' 接下来，您可以将其注册为 Vue
                            ...
                            <p>
                                ...
                                Highcharts-Vue 组件，只需要添加
                                highcharts元素，而且必须通过它的 :options
                                参数传递图表配置对象<br />
...
export default {
    ...
    components: { Header, Footer, bodyContent },
